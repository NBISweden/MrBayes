...
%%%% JN: Try to reduce vertical space around verbatim
\usepackage{etoolbox}
\makeatletter
...
%%%% JN: Currently, tttext is used instead of ttt
...
\begin{figure}[h]
\centering
\begin{BVerbatim}[baselinestretch=0.8,fontsize=\footnotesize]
                      MrBayes v3.2.7
...
\begin{Verbatim}[baselinestretch=0.8,fontsize=\footnotesize]
Model settings for partition 1:
Parameter        Options                      Current Setting
------------------------------------------------------------------
...
\begin{Verbatim}[baselinestretch=0.8,fontsize=\scriptsize]
Chain results (20000 generations requested):
...
\begin{figure}[h]
\centering
\begin{BVerbatim}[baselinestretch=0.8,fontsize=\scriptsize]
[ID: 0184438524]
...
\begin{figure}[h]
\begin{BVerbatim}[baselinestretch=0.8,fontsize=\small]
...
\begin{Verbatim}[baselinestretch=0.8,fontsize=\small]
...
\begin{Verbatim}[fbaselinestretch=0.8,ontsize=\small]
MrBayes > set autoclose=yes nowarnings=yes
MrBayes > execute primates.nex
\end{Verbatim}
