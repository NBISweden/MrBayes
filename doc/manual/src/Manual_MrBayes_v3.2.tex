...
\date{\large Draft version, January 2019}
...
%%%% JN: Nov-18: This section (above) about OS-specific installers needs to be rewritten
%%%% I suggest we skip the detailed installation procedures and instead refer to the 
%%%% INSTALL, and README documents on github.com.
...
%%%%% JN: I've done from the start until here (Nov 29 - 2018)
