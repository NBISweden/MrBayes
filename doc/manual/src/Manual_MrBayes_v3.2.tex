...
%%%% JN: Nov-18: This section about OS-specific installers needs to be rewritten
%%%% I suggest we skip the detailed installation procedures and instead refer to the 
%%%% INSTALL, and README documents on github.com.
...
%%%% 
The MrBayes package also come with example data files. These are intended to show
