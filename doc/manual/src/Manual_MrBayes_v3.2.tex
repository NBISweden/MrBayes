...
%%%% JN: far (around line #2477, Feb 2019).
...
presented by Kass and Raftery \citep{kass95} (see Table \ref{table:bftable}).
...
That said, it does not mean that if your SS-run did not finish it is completly wasted. As with
...
%%%% JN: Check if this is true: "However, the \ttt{mcmc} burnin parameters are ignored."
...
frequencies plotted at the end of SS analyzes, you may examine the \ttt{.ss} file to analyze precise
