...
%%%% JN: Orphan, commented, sentence below. Include or not?
...
delete fossils
\end{Verbatim}
%%%% JN: Note, the following paragraph describes non-existing commands in the hymfossils.nex!
%%%% JN: The current hymfossil.nex have the fossilized BD prior instead of "the relaxed clock model
%%%% JN: in the same way as the total-evidence analysis"!
...
%%%% JN: subsection need to be expanded. I pasted a block of text from another section below
