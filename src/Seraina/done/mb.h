...
#define NOT_APPLICABLE			-9999.0   //SK: used when doing reversible jump over stationary and directional model: root frequencies are not used when in stationary model
...
#define	PI_EQUAL						17
#define	PI_FIXED						18
#define DIRPI_DIRxDIR                  147 //SK
#define DIRPI_DIRxFIXED                148 //SK
#define DIRPI_FIXEDxDIR                149 //SK
#define DIRPI_FIXEDxFIXED              150 //SK
#define DIRPI_MIX                      151 //SK
#define	SHAPE_UNI						19
#define SHAPE_EXP						20
#define SHAPE_FIX						21
...
typedef struct model
    ...
    int			numDirParams;
    char		rootFreqPr[100];  /* prior for root state frequencies               */ //SK
...
typedef struct modelinfo
	...
	Param		*stateFreq;					/* ptr to statFreq used in model			*/ //SK: same pointer also used for the stationary-root freq vector
