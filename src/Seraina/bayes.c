...
#include "utils.h"
       ...
       const char* const svnRevisionBayesC="$Rev: 552 $";   /* Revision keyword which is expended/updated by svn on each commit/update*/
...
#	endif
	...
	strcpy(defaultModel.rootFreqPr, "Dirichlet");  /* prior for state frequencies at the root        */ //SK - not really necessary, as statefreqModel is set to 
...
//  defaultModel.brlensDir[1] = 20.0;                   /* 2nd param of invGamDir prior  */
    ...
    modelIndicatorParams = (char **) SafeCalloc (4, sizeof (char *));
    modelIndicatorParams[0] = "aamodel";
    modelIndicatorParams[1] = "gtrsubmodel";
    modelIndicatorParams[2] = "statefreqmodel";
    modelIndicatorParams[3] = "";

    /* Aamodel */
    modelElementNames = (char ***) SafeCalloc (4, sizeof (char **));
    ...
    /* State Frequency Model (e.g., stationary versus directional evolution) */
    modelElementNames[2]    = (char **) SafeCalloc (3, sizeof(char *));
    modelElementNames[2][0] = "stationary";
    modelElementNames[2][1] = "directional";
    modelElementNames[2][2] = "";

	/* Termination */
    modelElementNames[3]    = (char **) SafeCalloc (1, sizeof(char *));
    modelElementNames[3][0] = "";
